...
Tensor volume_render_cuvol_image(SparseGridSpec &, CameraSpec &,
                                 RenderOptions &);
Tensor volume_render_cuvol_image_nowarp(SparseGridSpec& , CameraSpec& , RenderOptions&);
Tensor volume_render_cuvol_image_tree_nowarp(SparseGridSpec&, TreeSpec& , CameraSpec& , RenderOptions&);
...
Tensor volume_render_svox1_image(SparseGridSpec &, CameraSpec &, RenderOptions &);
...
#define _REG_FUNC(funname) m.def(#funname, &funname)
 ...
 _REG_FUNC(volume_render_cuvol_image_nowarp);
  ...
  _REG_FUNC(volume_render_svox1_image);
  _REG_FUNC(volume_render_svox1_backward);
  _REG_FUNC(volume_render_svox1_fused);

  _REG_FUNC(volume_render_cuvol_image_tree_nowarp);
...
#undef _REG_FUNC
  ...
  py::class_<RaysSpec>(m, "RaysSpec")
      ...
      .def_readwrite("views", &RaysSpec::views);
  ...
  py::class_<RenderOptions>(m, "RenderOptions")
      ...
      .def_readwrite("use_nearest", &RenderOptions::use_nearest);
  ...
  py::class_<GridOutputGrads>(m, "GridOutputGrads")
      ...
      .def_readwrite("viewcount_helper", &GridOutputGrads::viewcount_helper);
